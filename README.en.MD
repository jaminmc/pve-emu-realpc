...
PVE Debain Ubuntu ArchLinux virtual machine emulates a physical machine
...
- `pve-edk2-firmware-ovmf_xxx.deb` you can also download from https://github.com/AICodo/pve-emu-realpc_edk2-firmware-ovmf
